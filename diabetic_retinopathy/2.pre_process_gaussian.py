...
test_dest0="/scratch/scratch2/_retinopathy/3.gaussian_test/0/"
test_dest1="/scratch/scratch2/_retinopathy/3.gaussian_test/1/"
test_dest2="/scratch/scratch2/_retinopathy/3.gaussian_test/2/"
test_dest3="/scratch/scratch2/_retinopathy/3.gaussian_test/3/"
test_dest4="/scratch/scratch2/_retinopathy/3.gaussian_test/4/"
...
train_dest0="/scratch/scratch2/_retinopathy/3.gaussian_train/0/"
train_dest1="/scratch/scratch2/_retinopathy/3.gaussian_train/1/"
train_dest2="/scratch/scratch2/_retinopathy/3.gaussian_train/2/"
train_dest3="/scratch/scratch2/_retinopathy/3.gaussian_train/3/"
train_dest4="/scratch/scratch2/_retinopathy/3.gaussian_train/4/"
...
def pre_processing(src, dest, flag):
    for file in glob.glob(src):
		...
		#scale
        	...
        	#cv2.GaussianBlur(input_img,(heightofKernel,widthofKernel),std_dev_x-direction,std_dev_y-direction)
        	gaussian_Blur = cv2.GaussianBlur(img2,(0,0),scale/30)

        	#image blending addWeighted(img1,alpha_val,img2,beta_val,gamma_scaler_Val)
        	img3=cv2.addWeighted (img2, 4,gaussian_Blur,-4,128)
...
print(" __________Gaussian Pre-processing__________")
...
print("Pre-process Gaussian completed")
